...
/**
 * Class CacheFlag_TokenParser
 */
class CacheFlag_TokenParser extends \Twig_TokenParser
{
	// Public Methods
	// =========================================================================
	...
	/**
	 * Parses {% cacheflag %}...{% endcacheflag %} tags.
	 *
	...
	public function parse(\Twig_Token $token)
	{
		...
		return new CacheFlag_Node($nodes, $attributes, $lineno, $this->getTag());
	}
